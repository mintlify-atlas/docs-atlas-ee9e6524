...
description: "Keyboard shortcuts, form navigation tips, and accessibility features available in the Amvel Warehouse browser application."
---
...
| `↑` / `↓` Arrow keys | Moves highlight up or down through the suggestion list |
| `Enter` or mouse click | Selects the highlighted suggestion and closes the list |
| `Escape` or blur (click away) | Closes the suggestion list without selecting |
